          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+17139225715" className="text-white/70 text-sm hover:text-[#F8B702] transition-colors duration-300">713-922-5715</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <FontAwesomeIcon icon={faEnvelope} className="text-[#F8B702] text-sm mt-1" />
                <div>
                  <a href="mailto:levi@levihomes.com" className="text-white/70 text-sm hover:text-[#F8B702] transition-colors duration-300">levi@levihomes.com</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <FontAwesomeIcon icon={faMapMarkerAlt} className="text-[#F8B702] text-sm mt-1" />
                <div>
                  <a href="https://maps.app.goo.gl/Z8Ce76dukE9KJT6W8" target="_blank" rel="noopener noreferrer" className="text-white/70 text-sm hover:text-[#F8B702] transition-colors duration-300">1001 S Dairy Ashford Rd #170, Houston, TX 77077</a>
                </div>
              </div>
            </div>
          </div>
